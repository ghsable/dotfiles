...
this script : [install.sh](https://github.com/ghsable/dotfiles/blob/main/bin/ime/install.sh)
...
this script : [fcitx_mozc.sh](https://github.com/ghsable/dotfiles/blob/main/bin/ime/fcitx_mozc.sh)
